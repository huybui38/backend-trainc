...
const get_course = require("../controllers/courses/get.course");
...
router.get("/:id/exercises", auth, getExercises_course);
router.get("/:id/students", auth, getStudents_course);
